...
public class ReversiBoardLogic extends GameBoardLogic {
    ...
    /**
     * This method initialises the gameBoard for reversi.
     */
    @Override
    ...
    /**
     * This method sets up a another testing scenario for debugging purposes. Should probably be removed eventually.
    ...
    public void setTestBoard2() {
        ...
        for(int i =0; i < testBoard.length; i++){
            if(i == 0 || i == 1 || i == 2 || i == 3 || i == 4 || i == 5 || i == 6 || i == 7 || i == 23 || i == 27 ||
                    i == 29 || i == 30 || i == 31 || i == 36 || i == 37 || i == 38 || i == 39 || i == 44 || i == 45 ||
                    i == 46 || i == 47 || i == 51 || i == 54 || i == 55 || i == 58 || i == 61 || i == 62 || i == 63 ){
                testBoard[i] = 2;
            } else if(i == 8 || i == 9 || i == 10 || i == 11 || i == 12 || i == 13 || i == 18 || i == 19 || i == 20 ||
                    i == 21 || i == 25 || i == 28 || i == 34 || i == 35 || i == 50 || i == 52 || i == 53){
                testBoard[i] = 1;
            }
        }
